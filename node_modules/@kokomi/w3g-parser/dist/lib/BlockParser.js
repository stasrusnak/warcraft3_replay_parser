...
const MetadataParser_js_1 = require("./MetadataParser.js");
const decompressor = (data) => {
    return zlib_1.default.inflateSync(data, { finishFlush: zlib_1.default.constants.Z_SYNC_FLUSH });
};
class BlockParser {
    parseBlocks(bb, blockCount, isReforged) {
        let decompressedData = new bytebuffer_1.default(8192, true);
...
const parseGameRecord = (bb) => {
    ...
    return {
        ...
        gameType,
        languageId,
        statString: (0, MetadataParser_js_1.parseStatString)((0, MetadataParser_js_1.decodeGameStatString)(statStringRaw)),
    };
};
